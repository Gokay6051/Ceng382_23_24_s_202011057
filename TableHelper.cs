...
public static class TableHelper
{
    ...
    public static void PrintTable(string[,] table)
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            for (int j = 0; j < 10; j++)
            {
                Console.Write($"{table[i, j].PadRight(7)}|");
            }
            Console.WriteLine();
            Console.WriteLine("-----+-------+-------+-------+-------+-------+-------+--------+------+-------+-------+");
        }
    ...
    public static void ViewReservations(ref ReservationHandler Reservations)
    {
        ...
        Reservations.DisplayWeekSchedule(room-1);
    }
    ...
    public static void CreateReservations(ref ReservationHandler Reservations, ref RoomData RoomData)
    {
        ...
        Reservations.AddReservation("Ceren", 2, 6, 4, RoomData.Rooms[2]);
        ...
        Reservations.AddReservation("Deniz", 1, 6, 1, RoomData.Rooms[1]);
        Reservations.AddReservation("Ceren", 2, 6, 8, RoomData.Rooms[2]);
        Reservations.AddReservation("Hüseyin", 3, 3, 4, RoomData.Rooms[3]);
        ...
        Reservations.AddReservation("Şeyma", 14, 6, 9, RoomData.Rooms[14]);
    ...
    public static void DeleteReservation(ref ReservationHandler Reservations)
    {
        ...
        Reservations.DeleteReservation(room-1, day-1, time-1);
    }
